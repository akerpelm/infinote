...
export const login = user => dispatch => SessionApiUtil.postSession(user)
    .then(currentUser => dispatch(receiveCurrentUser(currentUser)), err => (dispatch(receiveErrors(err.responseJSON))))
